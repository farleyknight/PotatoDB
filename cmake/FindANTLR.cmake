...
if(DEFINED ANTLR_EXECUTABLE)
  message(STATUS "ANTLR_EXECUTABLE is set to ${ANTLR_EXECUTABLE}")
else()
  message(FATAL_ERROR "ANTLR_EXECUTABLE is not set! Please set it before continuing.")
endif()

if(DEFINED Java_JAVA_EXECUTABLE)
  message(STATUS "Java_JAVA_EXECUTABLE is set to ${Java_JAVA_EXECUTABLE}")
else()
  message(FATAL_ERROR "Java_JAVA_EXECUTABLE is not set! Please set it before continuing.")
endif()
...
if(ANTLR_EXECUTABLE AND Java_JAVA_EXECUTABLE)
  ...
  message(STATUS "ANTLR_COMMAND_RESULT: ${ANTLR_COMMAND_RESULT}")
  ...
  macro(ANTLR_TARGET Name InputFile)
    ...
    message(STATUS "Building parser for ${Name}...")
